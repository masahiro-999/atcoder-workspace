...
# num_in_gcd = gcd_nm//N -1 + gcd_nm//M -1

# num_loop = K // num_in_gcd
# k = K % num_in_gcd

def check(t,k):
    n = t//lcm_nm
    r = t % lcm_nm
    # print(t, (lcm_nm//N -1) * n + r//N + (lcm_nm//M -1) * n + r//M,k)
    return (lcm_nm//N -1) * n + r//N + (lcm_nm//M -1) * n + r//M >= k

l = 0
r = 100000000_00000000_0000000000
# r = 500000002500000000
while r-l > 1:
    mid = (l+r)//2
    if check(mid, K):
        r = mid
